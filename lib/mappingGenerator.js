...
- propertyTypeFromText: extracts a conservative property type from a title or description. No args needed.
...
async function generateMappingRecipe(records, options = {}) {
  if (!Array.isArray(records) || records.length === 0) {
    throw new Error('Cannot generate an AI mapping recipe without source records.');
  }
