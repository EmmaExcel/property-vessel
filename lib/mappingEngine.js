...
function propertyTypeFromText(value) {
  const text = String(value || '');
  const patterns = [
    ['semi-detached house', /\bsemi[\s-]?detached\b/i],
    ['detached house', /\bdetached\b/i],
    ['terraced house', /\b(?:end[\s-]?terrace|terraced?|townhouse|town house)\b/i],
    ['maisonette', /\bmaisonette\b/i],
    ['apartment', /\b(?:apartment|flat)\b/i],
    ['bungalow', /\bbungalow\b/i],
    ['cottage', /\bcottage\b/i],
    ['studio', /\bstudio\b/i],
    ['house', /\b(?:house|home|residence)\b/i],
    ['commercial property', /\b(?:commercial|retail|office|warehouse)\b/i],
    ['land', /\b(?:plot|land)\b/i],
  ];
